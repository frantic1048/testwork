...
describe('chartTest', () => {
  it('chart', async () => {
    ...
    await driver.findElement(
      By.css(adAnalysis.concat('ul>li:nth-child(1) a[href="/anli/ad_analysis_compare.php"]')))
      .click();
    ...
    await driver.findElement(
      By.css(adAnalysis.concat('ul>li:nth-child(2) a[href="/anli/ad_analysis_trend1.php"]')))
      .click();
