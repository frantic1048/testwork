...
//进入通知界面
	    ...
	    expect(driver.getCurrentUrl())
	      ...
	      .and.notify(done);
	    //点击删除
	    driver.findElement(By.css('#content > div.container-fluid > div > div > div > div.widget-content.nopadding > ul > li:nth-child(1) > div.article-post > div > button')).click();
	    //处理浏览器弹框
